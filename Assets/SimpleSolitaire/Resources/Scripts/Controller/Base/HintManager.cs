...
namespace SimpleSolitaire.Controller
{
    ...
    public abstract class HintManager : MonoBehaviour
    {
        ...
        public bool IsMagicWangProcess = false;
        ...
        public int[] DefaultCountsLevels;
        public int AvailableCountLevels
        {
            get 
            {
                return _availableCountLevels;
            } 
        ...
        private int _availableCountLevels;
        ...
        /// </summary>
        public abstract void GenerateHints(bool isAutoComplete = false);
        ...
        protected void ActivateHintButton(bool isActive)
        {
            ...
            //_countIndicator.color = isActive ? Color.white : new Color(1, 1, 1, 0.5f);
            _hintButtonImage.sprite = isActive ? _hintButtonSpriteActive : _hintButtonSpriteInActive;
            _countIndicatorImage.sprite = isActive ? _countIndicatorSpriteActive : _countIndicatorSpriteInActive;
        }
