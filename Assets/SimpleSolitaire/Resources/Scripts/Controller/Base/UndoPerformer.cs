...
namespace SimpleSolitaire.Controller
{
    public abstract class UndoPerformer : MonoBehaviour
    {
        ...
        [SerializeField] private int _rewardUndoCounts;

        public int[] DefaultUndoCountsLevels;
        ...
        public void UpdateUndoCounts()
        {
            if (IsCountable)
            {
                ...
                AvailableUndoCounts = _rewardUndoCounts;
                _undoAvailableCountsText.text = AvailableUndoCounts.ToString();
    ...
    public class TripeaksCardRecord : CardRecord
    {
        ...
        public TripeaksCardRecord(Card card, TripeaksCardPositionInfo info) : base(card)
        {
            InfoId = info.Id;
        }
    }
    ...
    public class TripeaksDeckRecord : DeckRecord
    {
        ...
        public TripeaksDeckRecord(List<Card> cards, int deckNum) : base(cards, deckNum)
        {
            ...
            foreach (var item in cards)
            {
                TripeaksCard tripeaksCard = item as TripeaksCard;
                CardsRecord.Add(new TripeaksCardRecord(tripeaksCard, tripeaksCard.Info));
            }
        }
    }
}