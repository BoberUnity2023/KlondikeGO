...
namespace SimpleSolitaire.Controller
{
    public abstract class Card : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IPointerClickHandler, IPointerDownHandler, IPointerUpHandler
    {
        ...
        private bool _isDragEffectActive;
        private Deck _deck;
        ...
        public MoveTransformTo MoveTransformTo
        {
            get 
            {
                if (_moveTransformTo == null)
                    _moveTransformTo = GetComponent<MoveTransformTo>();

                return _moveTransformTo; 
            }
        }
        ...
        public void OnDrag(PointerEventData eventData)
        {
            ...
            {
                Vector3 offset = (_newPosition - _lastMousePosition) * (1080 /(float)UnityEngine.Screen.height) * (_canvasScaler.referenceResolution.y) / 1080;
                ...
                _deck.SetPositionFromCard(this, transform.localPosition.x, transform.localPosition.y);
            }
        ...
        public void OnPointerDown(PointerEventData eventData)
        {
            ...
            if (IsDraggable)
            {
                _isDragEffectActive = true;
                DragEffect("On", cardsToTop); 
            }
        }

        public void OnPointerUp(PointerEventData eventData)
        {            
            if (_isDragEffectActive)
                DragEffect("Off");
        }
