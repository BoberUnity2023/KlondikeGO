...
namespace SimpleSolitaire.Controller
{
    public class StatisticsController : MonoBehaviour
    {
        ...
        private readonly string _statisticTripeaksPrefs = "STATISTICS_TRIPEAKS";
        ...
        private void SaveStatisticInPrefs()
        {
            ...
            else if (_cardLogicComponent is TripeaksCardLogic)
            {
                SaveByRule(_statisticTripeaksPrefs);
            }
        }
        ...
        private void GetStatisticFromPrefs()
        {
            ...
            {
                GetByRule(_statisticTripeaksPrefs);
            }
        }
        ...
        /// <summary>
        /// Increase played games _time amount value. 
        /// </summary>
        ...
        /// <summary>
        /// Get average game _time value from formula "average = all _time / games_amount"
        /// </summary>
        ...
        /// <summary>
        /// This method converting long value into string _time format HH:mm:ss
        /// </summary>
        /// <param name="timeAmount">Time counter</param>
        /// <returns>Time in sring format HH:mm:ss</returns>
        public string ConvertLongToTimeFormat(long timeAmount)
        {
            ...
            output += string.Format("{0,2}:{1,2}", min.ToString().PadLeft(2, '0'), sec.ToString().PadLeft(2, '0'));
