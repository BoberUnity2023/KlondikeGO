    ...
    public class SpiderHintManager : HintManager
    {
        ...
        protected override IEnumerator HintTranslate(HintData data)
        {
            ...
            while (t < 1)
            {
                ...
                hintCard.transform.localPosition = Vector3.Lerp(hintElement.FromPosition,
            ...
            {
                hintCard.Deck.UpdateCardsPosition(false);
                hintCard.transform.localPosition = hintElement.FromPosition;
        ...
        public override void GenerateHints(bool isAutoComplete = false)
        {
            ...
            ActivateHintButton(IsHasAutoCompleteHint());//IsHasHint()
