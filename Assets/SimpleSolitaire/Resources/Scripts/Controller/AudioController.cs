...
namespace SimpleSolitaire.Controller
{
    public class AudioController : MonoBehaviour
    {
        ...
        [SerializeField] private AudioClip _cardTake;
        [SerializeField] private AudioClip _cardPut;
        ...
        private void PlayInternal(AudioType type)
        {
            switch (type)
            {
                ...
                case AudioType.WindowOpen:
                    ...
                    break;
                case AudioType.CardTake:
                    _mainSource.PlayOneShot(_cardTake);
                    break;
                case AudioType.CardPut:
                    PlayCardPutLogic();
                    break;
                case AudioType.Buy:
                    _mainSource.PlayOneShot(_buy);
                    break;
                case AudioType.Bonus:
                    _mainSource.PlayOneShot(_bonus);
                    break;
            }
        }
        ...
        private float _cardPutLastPlayTime;
        ...
        private void PlayCardPutLogic()
        {
            if (Time.time - _cardPutLastPlayTime > _cardPut.length/2.0f)
            {
                _mainSource.PlayOneShot(_cardPut);
                _cardPutLastPlayTime = Time.time;
            }
        }
