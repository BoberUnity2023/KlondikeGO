...
namespace I2.Loc
{
    ...
    public class Localize : MonoBehaviour
    {
		...
		public bool AlwaysForceLocalize;			// Force localization when the object gets enabled (useful for callbacks and parameters that change the localization even through the language is the same as in the previous _time it was localized)
